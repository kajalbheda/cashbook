        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Payment Modes</span>
                </div>
            </div>
            ...
            <form action="" method="POST">
                ...
                <table id="category-table" class="table  table-bordered table-striped table-hover ">
                    ...
                    <div class="panel-heading mx-3">
                        ...
                        <a href="javascript:delete_selected('delete','/admin/paymentmode/multidel');" id="delete_selected" class="btn btn-danger"
                        ...
                        @foreach ($record as $row)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href='{{ url("/admin/paymentmode/edit/{$row->id}") }}'
                                        class="list-icons-item text-indigo" data-popup="tooltip" title=""
                                        data-original-title="Edit"><i class="icon-pencil7"></i></a>&nbsp;
                                    <a href="javascript:delete_record({{ $row->id }},'/admin/paymentmode/delete','Deleted');"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/admin/paymentmode/add" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    <label>Name</label>
                                    <input type="text" placeholder="Mode Name" name="modename" class="form-control">
                                </div>
                            </div>
                        </div>
